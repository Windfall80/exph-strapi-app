...
export class OfertasRelampagoComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  displayedColumns: string[] = ['select', 'id', 'company', 'offer', 'date', 'status', 'price', 'badges', 'actions'];
