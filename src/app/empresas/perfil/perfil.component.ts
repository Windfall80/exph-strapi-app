...
export class PerfilComponent implements OnInit {
  ...
  public exportReport() {
    let params = new HttpParams();
    this.http.get<any>(`${environment.apiUrl}/companies/export-quotations-report`, { params, responseType: 'blob' as 'json',observe: 'response' }).subscribe(
      (response: any)=>{
  ...
  getSubscriptionDate(){
    this.http.get<any>(`${environment.apiUrl}/companies/subscription_date`).subscribe(
      (response: any)=>{
